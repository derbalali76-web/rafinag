...
window.saveDubai=()=>{
    ...
    emitEvent('DUBAI',
        {o,w,sp,disc,usd,rate:dollarRate,fromDebt,fromInv,barsRemove,barUpdates},
...
window.doXfer=()=>{
    ...
    toast(`🔁 حُوّل ${fmt(W,dec)} ${unit} من ${_settleCustomer} إلى ${to}`+((isGold&&_xferMode==='conv')?` (محوّل لـ${dstType})`:'')+((feeFrom||feeTo)?' + أجرة':''),'success');
};
    ...
    document.getElementById('archiveList').innerHTML=goldList.length?goldList.map(inv=>`
        <div class="saved-card">
            ...
            <div style="display:flex;gap:.3rem">
                ...
                <button class="btn-pdf" onclick="printInv('${inv.id}')"><i class="fas fa-file-pdf"></i></button>
    ...
    document.getElementById('rafArchiveList').innerHTML=rafInvoices.length?rafInvoices.map(r=>`
        <div class="saved-card">
            ...
            <div style="display:flex;gap:.3rem">
                ...
                <button class="btn-pdf" onclick="printRaf('${r.id}')"><i class="fas fa-file-pdf"></i></button>
    ...
    document.getElementById('dollArchiveList').innerHTML=dollInvoices.length?dollInvoices.map(d=>`
        <div class="saved-card">
            ...
            <div style="display:flex;gap:.3rem">
                ...
                <button class="btn-pdf" onclick="printDoll('${d.id}')"><i class="fas fa-file-pdf"></i></button>
    ...
    document.getElementById('dubaiArchiveList').innerHTML=dubaiInvoices.length?dubaiInvoices.map(d=>`
        <div class="saved-card">
            ...
            <div style="display:flex;gap:.3rem">
                ...
                <button class="btn-pdf" onclick="printDubai('${d.id}')"><i class="fas fa-file-pdf"></i></button>
