...
const CACHE = CACHE_PREFIX + 'v307';
const ASSETS = [
  './','./index.html',
  './firebase.js?v=307','./app.js?v=307','./assistant.js?v=307',
  './inventory.js?v=307','./invoice.js?v=307','./raffinage.js?v=307',
  './workshops.js?v=307','./auth.js?v=307',
