...
const CACHE = CACHE_PREFIX + 'v385';
const ASSETS = [
  './','./index.html',
  './style.css?v=385',
  './firebase.js?v=385','./app.js?v=385','./assistant.js?v=385',
  './inventory.js?v=385','./invoice.js?v=385','./raffinage.js?v=385',
  './workshops.js?v=385','./auth.js?v=385',
  './manifest.json',
